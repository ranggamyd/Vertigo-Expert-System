         ...
         <form action="" method="post">
            <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <input type="username" class="form-control <?= form_error('username') ? 'is-invalid' : '' ?>" id="username" name="username" value="<?= $username ?>" placeholder="Masukkan username" value="<?= $username ?>" required>
